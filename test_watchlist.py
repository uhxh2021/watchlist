...
class WatchlistTestCase(unittest.TestCase):
    ...
    def test_create_item(self):
        ...
        response = self.client.post('/index', data=dict(
            title='New Movie',
            year='2020'
        ), follow_redirects=True)
        data = response.get_data(as_text=True)
    ...
    def test_login_protect(self):
        ...
        # self.assertNotIn('<form method="post">', data)  # 因为提交add条目的post，改成了不看是否登陆，post时再跳转login页面
    ...
    def test_admin_command(self):
        ...
        self.assertIn('Create Done.', result.output)
